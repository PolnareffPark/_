...
# [WARNING] PERMUTE_TARGET=1 → 타깃 무작위화로 누수 검사 모드
PERMUTE_TARGET    = (_os.environ.get("PERMUTE_TARGET","1") == "1")
ANCHOR_FROM_CROSS = (_os.environ.get("ANCHOR_FROM_CROSS","0") == "1")
USE_RM_TRAINONLY  = (_os.environ.get("USE_RM_TRAINONLY","0") == "1")  # 기본 OFF
# [INFO] LEAK_AUTOCHECK=1 → 빠른 퍼뮤테이션 감사 자동 수행
